...
typedef struct
{
	...
	__IO uint32_t AHB1LPENR;    //!# RCC AHB1 peripheral clock enable low power mode register | offset: 0x50
	__IO uint32_t AHB2LPENR;    //!# RCC AHB2 peripheral clock enable low power mode register | offset: 0x54
	__IO uint32_t AHB3LPENR;    //!# RCC AHB3 peripheral clock enable low power mode register | offset: 0x58
		 uint32_t RESERVED4;    //!# Reserved                                                 | offset: 0x5C
	__IO uint32_t APB1LPENR;    //!# RCC APB1 peripheral clock enable low power mode register | offset: 0x60
	__IO uint32_t APB2LPENR;    //!# RCC APB2 peripheral clock enable low power mode register | offset: 0x64
