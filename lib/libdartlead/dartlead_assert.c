...
/**
 * @details The red LED is connected to PB14. Thus PB14 needs to be configured as a barebones output pin and
 *          afterwards repeatedly blink the LED. This function is forcefully optimized at -O0 to prevent the
 *          optimizer from taking out the dumb for-loop.
 */
