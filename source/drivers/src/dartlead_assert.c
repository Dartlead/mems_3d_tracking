...
/*! Custom assert.
 *
 * @brief The red LED is connected to PB14. Thus PB14 needs to be configured as a barebones output pin and
 *        afterwards repeatedly blink the LED.
 */
void __attribute__((optimize("O0"))) dartlead_assert(void) {
